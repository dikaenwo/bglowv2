...
export const icons = {
  ...
  skinScan: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M3.5 11.5h17" stroke-width="2.2" />
  </svg>`,
